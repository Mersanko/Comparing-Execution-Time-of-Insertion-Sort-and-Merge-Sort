...
class timecomplexity():
    ...
    def driverCode(self):
        ...
        for i in range(1,30):
            ...
            print(len(a), "Elements sorted by Insertion Sort in", endForInsertion-startForInsertion)
            elementsForInsertion.append(len(a))
            timesForInsertion.append(endForInsertion-startForInsertion)


            print(len(a), "Elements sorted by Merge Sort in", endForMerge-startForMerge)
